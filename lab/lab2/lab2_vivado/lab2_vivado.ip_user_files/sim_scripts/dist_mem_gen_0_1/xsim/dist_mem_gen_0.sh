...
#
# Script generated by Vivado on Sat Mar 30 13:10:21 CST 2024
...
# script info
echo -e "dist_mem_gen_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L dist_mem_gen_v8_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dist_mem_gen_0 xil_defaultlib.dist_mem_gen_0 xil_defaultlib.glbl -log elaborate.log
}
