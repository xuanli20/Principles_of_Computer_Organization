...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kuro/Principles_of_Computer_Organization/lab/lab4/lab4_vivado/lab4_vivado.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key DATA_MEM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc DATA_MEM_simv.daidir vcs_lib c.obj)
