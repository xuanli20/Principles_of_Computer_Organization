...
#
# Script generated by Vivado on Mon Apr 15 12:23:16 CST 2024
...
#
# Usage        : DATA_MEM.sh
#                DATA_MEM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DATA_MEM.sh [-reset_run]
#                DATA_MEM.sh [-reset_log]
#                DATA_MEM.sh [-help]
#
...
#                script (type 'DATA_MEM.sh -help' for more information).
#
...
# script info
echo -e "DATA_MEM.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DATA_MEM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.DATA_MEM xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.DATA_MEM -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/kuro/Principles_of_Computer_Organization/lab/lab4/lab4_vivado/lab4_vivado.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log DATA_MEM_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: DATA_MEM.sh [-step]\n\
Usage: DATA_MEM.sh [-lib_map_path]\n\
Usage: DATA_MEM.sh [-reset_run]\n\
Usage: DATA_MEM.sh [-reset_log]\n\
Usage: DATA_MEM.sh [-keep_index]\n\
