...
#
# Script generated by Vivado on Mon Apr 15 15:00:29 CST 2024
...
# script info
echo -e "TB.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L dist_mem_gen_v8_0_14 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot TB xil_defaultlib.TB xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim TB -key {Behavioral:sim_1:Functional:TB} -tclbatch cmd.tcl -log simulate.log
}
